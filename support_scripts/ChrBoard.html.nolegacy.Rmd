...
subplot( pl0 , pl16 , style(pl14,showlegend = F) , style(pl15,showlegend = F) , pl13 , nrows = 5, shareX = T , titleY = T , titleX=T , heights = c(0.5,  0.08 , 0.08 , 0.08 , 0.18))
```
...
```{r}
subplot(pl7 , style(pl5,showlegend = F) , style(pl6,showlegend = F) ,pl1, style(pl2 , showlegend = F) , nrows = 5, shareX = T , titleY = T , titleX=T , heights = c(0.08, 0.1 , 0.1 , 0.25 , 0.37))
```
...
```{r}
subplot(pl11 , style(pl9,showlegend = F) , style(pl10,showlegend = F) ,pl3, style(pl4 , showlegend = F) , nrows = 5, shareX = T , titleY = T , titleX=T , heights = c(0.08, 0.1 , 0.1 , 0.25 , 0.37))
```
