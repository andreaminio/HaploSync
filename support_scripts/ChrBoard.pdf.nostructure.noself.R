...
maxWidth <- unit.pmax( gt1_widths, gt2_widths, gt3_widths , gt5_widths , gt6_widths , gt8_widths)
...
g <- arrangeGrob( gt1 , gt5 , gt6 , gt8, gt2 , gt3, layout_matrix=layout , heights=c(.25, .05 , .05 , .05 , .1 , .2) )
