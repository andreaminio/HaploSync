...
if (!(empty(markers_hap2)))         {p0 <- p0 + geom_segment(data = markers_hap2      , mapping = aes(x = coords, y = 0.6  , xend = coords, yend = 0.73 , color = marker_order)) }
if (!(empty(markers_hap2_used)))    {p0 <- p0 + geom_segment(data = markers_hap2_used , mapping = aes(x = coords, y = 0.53 , xend = coords, yend = 0.58 ) , color = "white" ) }
...
if (!(empty(markers_hap2)))         { p0_noLabels <- p0_noLabels + geom_segment(data = markers_hap2      , mapping = aes(x = coords, y = 0.6  , xend = coords, yend = 0.73 , color = marker_order)) }
if (!(empty(markers_hap2_used)))    { p0_noLabels <- p0_noLabels + geom_segment(data = markers_hap2_used , mapping = aes(x = coords, y = 0.53 , xend = coords, yend = 0.58 ) , color = "white" ) }
