...
```{r}
subplot(pl1, style(pl2 , showlegend = F) , nrows = 2, shareX = T , titleY = T , titleX=T , heights = c(0.3, 0.7))
```
...
```{r}
subplot(pl3, style(pl4 , showlegend = F) , nrows = 2, shareX = T , titleY = T , titleX=T , heights = c(0.3, 0.7))
```
