...
subplot( pl0 , pl17 ,  pl13 , nrows = 3, shareX = T , titleY = T , titleX=T , heights = c(0.6 , 0.15 , 0.25))
```
...
```{r}
subplot( pl8 , pl1, style(pl2 , showlegend = F) , nrows = 3, shareX = T , titleY = T , titleX=T , heights = c(0.15, 0.35 , 0.5))
```
...
```{r}
subplot( pl12  ,pl3, style(pl4 , showlegend = F) , nrows = 3, shareX = T , titleY = T , titleX=T , heights = c(0.15, 0.35 , 0.5))
```
