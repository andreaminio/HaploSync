...
subplot( pl0 , pl17 , style(pl14,showlegend = F) , style(pl15,showlegend = F) , pl13 , nrows = 5, shareX = T , titleY = T , titleX=T , heights = c(0.5, 0.08 , 0.08 , 0.08 , 0.22))
```
...
```{r}
subplot( pl8 , style(pl5,showlegend = F) , style(pl6,showlegend = F) ,pl1, style(pl2 , showlegend = F) , nrows = 5, shareX = T , titleY = T , titleX=T , heights = c(0.1 , 0.1 , 0.1 , 0.3 , 0.4))
```
...
```{r}
subplot( pl12 , style(pl9,showlegend = F) , style(pl10,showlegend = F) ,pl3, style(pl4 , showlegend = F) , nrows = 5, shareX = T , titleY = T , titleX=T , heights = c(0.1 , 0.1 , 0.1 , 0.3 , 0.4))
```
