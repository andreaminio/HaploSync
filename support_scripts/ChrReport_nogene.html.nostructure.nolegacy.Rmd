...
#  geom_point(aes(x = tStop, y = qStop, color = identity),size = 0.009) +
  scale_color_manual(name = "", breaks = c( nucmer_query , paste0( nucmer_ref , "<br>(Self)") ) , values = c("black", "gray66") ) +
...
subplot( pl0 ,  style(pl14,showlegend = F) , style(pl15,showlegend = F) , nrows = 3, shareX = T , titleY = T , titleX=T , heights = c(0.68, 0.1 , 0.08 ))
```
