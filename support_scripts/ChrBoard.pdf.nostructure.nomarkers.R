...
maxWidth <- unit.pmax(gt0_widths, gt1_widths, gt2_widths, gt3_widths , gt8_widths)
...
g <- arrangeGrob( gt0, gt1 , gt8, gt2 , gt3, layout_matrix=layout , heights=c(.25, .25, .05 , .1 , .2) )
