...
subplot( pl0 , pl16 , pl13 , nrows = 3, shareX = T , titleY = T , titleX=T , heights = c(0.7, 0.1 , 0.2))
```
...
```{r}
subplot(pl7 ,pl1, style(pl2 , showlegend = F) , nrows = 3, shareX = T , titleY = T , titleX=T , heights = c(0.1 , 0.35 , 0.55))
```
...
```{r}
subplot(pl11 , pl3, style(pl4 , showlegend = F) , nrows = 3, shareX = T , titleY = T , titleX=T , heights = c(0.1 , 0.35 , 0.55))
```
