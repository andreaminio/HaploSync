...
pg          <- arrangeGrob( gt1 , gt2 , layout_matrix=layout , heights=c(.75, .25 ) )
...
==============================================================
```{r}
subplot( pl0 , style(pl2,showlegend = F) , nrows = 2 , titleY = T , titleX=T , margin = c(0 , 0 , 0.05 , 0.05) , heights = c(0.75 , 0.25 ) )
```
