...
maxWidth <- unit.pmax(gt1_widths, gt2_widths, gt3_widths , gt5_widths , gt6_widths , gt7_widths)
...
g <- arrangeGrob( gt1 , gt5 , gt6 , gt7 , gt2 , gt3, layout_matrix=layout , heights=c(.35 , .1 , .1 , .1 , .15 , .3) )
