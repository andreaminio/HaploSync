...
```{r}
subplot( pl8 , pl1, style(pl2 , showlegend = F) , nrows = 3, shareX = T , titleY = T , titleX=T , heights = c(0.08, 0.25 , 0.37))
```
...
```{r}
subplot( pl12 , pl3, style(pl4 , showlegend = F) , nrows = 3, shareX = T , titleY = T , titleX=T , heights = c(0.08, 0.25 , 0.37))
```
