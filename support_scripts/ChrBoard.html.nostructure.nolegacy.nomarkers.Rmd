...
subplot( pl0 , pl13 , nrows = 2, shareX = T , titleY = T , titleX=T , heights = c(0.8, 0.2 ))
```
...
```{r}
subplot(pl1, style(pl2 , showlegend = F) , nrows = 2, shareX = T , titleY = T , titleX=T , heights = c(0.4, 0.6))
```
...
```{r}
subplot(pl3, style(pl4 , showlegend = F) , nrows = 2, shareX = T , titleY = T , titleX=T , heights = c(0.4, 0.6))
```
