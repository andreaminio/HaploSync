...
maxWidth <- unit.pmax( gt1_widths, gt2_widths, gt3_widths , gt7_widths , gt8_widths)
...
g <- arrangeGrob( gt1 , gt7 , gt8, gt2 , gt3, layout_matrix=layout , heights=c(.35, .1 , .1 , .15 , .25) )
